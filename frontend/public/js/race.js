...
const backendUrl = '/score/add'; // Replace with your backend API endpoint

fetch(backendUrl, {
method: 'POST',
headers: {
'Content-Type': 'application/json',
//   'Access-Control-Allow-Origin': '*', // Set the CORS header here (optional)
},
...
function endGame(){
    ...
    startScreen.innerHTML="Game Over <br> Final score:"+player.score+" "+"<br>Press again to restart";
      sendScoreToBackend(player.score);         
}
